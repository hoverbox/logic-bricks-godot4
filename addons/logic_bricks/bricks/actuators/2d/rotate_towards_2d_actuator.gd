...
func get_property_definitions()->Array: return [{"name":"target_mode","type":TYPE_STRING,"hint":PROPERTY_HINT_ENUM,"hint_string":"Node Name,Group","default":"node_name"},{"name":"target_name", "required": true, "required_label": "a target node or group name", "group_picker": true, "group_picker_if": {"target_mode": "group"},"type":TYPE_STRING,"default":""},{"name":"speed","type":TYPE_STRING,"default":"180.0"},{"name":"angle_offset","type":TYPE_STRING,"default":"0.0"}]
func get_tooltip_definitions() -> Dictionary:
	return {
		"_description": "Turns a Node2D toward another node or the nearest member of a group.",
		"target_mode": "Find a target by node name or choose the nearest node in a group.",
		"target_name": "Target node name or group name.",
		"speed": "Rotation speed in degrees per second. Use 0 to snap instantly.",
		"angle_offset": "Additional angle for artwork that does not face right by default.",
	}
