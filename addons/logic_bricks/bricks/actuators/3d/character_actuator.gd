...
func generate_code(node: Node, chain_name: String) -> Dictionary:
	...
	post_process.append("	var _logic_brick_accel_step = maxf(absf(_logic_brick_target_hvel.x), absf(_logic_brick_target_hvel.y)) * _logic_brick_character_acceleration * 12.0 * delta")
