...
func get_property_definitions() -> Array:
	return [
		...
		{"name":"target_node_name", "required": true, "required_label": "a target node name", "required_if": {"target_mode": "node_name"},"type":TYPE_STRING,"default":"","placeholder":"Node2D or Node3D name","visible_if":{"target_mode":"node_name"}},
		...
		{"name":"position_variable", "required": true, "required_label": "a Position variable", "required_if": {"set_position": true, "position_mode": "vector_variable"},"type":TYPE_STRING,"default":"","visible_if":{"position_mode":"vector_variable"}},
		...
		{"name":"rotation_variable", "required": true, "required_label": "a Rotation variable", "required_if": {"set_rotation": true, "rotation_mode": "variable"},"type":TYPE_STRING,"default":"","visible_if":{"rotation_mode":"variable"}},
		...
		{"name":"scale_variable", "required": true, "required_label": "a Scale variable", "required_if": {"set_scale": true, "scale_mode": "vector_variable"},"type":TYPE_STRING,"default":"","visible_if":{"scale_mode":"vector_variable"}},
