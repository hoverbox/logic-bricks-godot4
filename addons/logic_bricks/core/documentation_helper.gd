...
const BRICK_DOCS: Dictionary = {
	...
	"MoveTowards2DActuator": {"2d": "actuators-2d.html#move-towards-2d"},
	"MoveTowardsActuator": {"3d": "actuators-3d.html#move-towards-3d"},
	...
	"RotationActuator": {"3d": "actuators-3d.html#motion-3d"},
	...
	"ScaleActuator": {"2d": "actuators-2d.html#set-transforms-2d", "3d": "actuators-3d.html#set-transforms-3d"},
